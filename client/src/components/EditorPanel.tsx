...
const EditorPanel = ({selectedElement, onUpdate, onClose} : EditorPanelProps ) => {
  ...
  const [values, setValues] = useState<EditorPanelProps["selectedElement"]>(selectedElement);


  useEffect(() => {
    if (selectedElement && selectedElement !== values) {
    ...
    const handleChange = (field: string, value: string) => {
        ...
        if(field in values.styles){
            newValues.styles  = {...values.styles}
        }
